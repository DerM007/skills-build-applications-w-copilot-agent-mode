...
class TeamModelTest(TestCase):
    def test_create_team(self):
        user = User.objects.create(_id=ObjectId(), username='teamuser', email='teamuser@example.com', password='password')
...
class ActivityModelTest(TestCase):
    def test_create_activity(self):
        user = User.objects.create(_id=ObjectId(), username='activityuser', email='activityuser@example.com', password='password')
...
class LeaderboardModelTest(TestCase):
    def test_create_leaderboard_entry(self):
        user = User.objects.create(_id=ObjectId(), username='leaderboarduser', email='leaderboarduser@example.com', password='password')
